...
const ReportGenerateModal = ({ open, onClose }) => {
    ...
    const propertyReportHandler = (value) => {
        if (value !== "Select") {
            window.open(`http://localhost:8000/api/property/export/${value}`, "_blank");
        }
    };

    const otherReportHandler = (value) => {
        if (value !== "Select") {
            window.open(`http://localhost:8000/api/${value}`, "_blank");
        }
    };
                                ...
                                <div className="flex flex-col px-4 py-3 sm:flex sm:px-6">
                                    <div className="flex flex-col gap-y-4">
                                        <div className="pb-4 border-b border-gray-200">
                                            ...
                                            <a
                                                href="http://localhost:8000/api/admin/export/report"
                                                target="_blank"
